@extends('LayoutAdmin.app', ['title' => 'Pengumuman'])
                    ...
                    <tbody>
                        @foreach ($pengumuman as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ asset('storage/filePengumuman/' . $item->file) }}" target="_blank">Lihat File Pengumuman
                                        </a>
                                </td>
                                ...
                                <td class="text-end pe-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/admin/pengumuman/edit/{{ $item->id }}"
                                                class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/admin/pengumuman/delete/{{ $item->id }}" class="menu-link px-3"
