        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Formulir Permohonan Informasi</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ url('/admin/fpi') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div style="max-height: 66vh; overflow: auto">
                            <div class="mb-3">
                                <label for="judul_serta_merta" class="form-label">Judul Formulir <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="judul_serta_merta" id="judul_serta_merta"
                                    required placeholder="Masukkan Judul Formulir Permohonan Informasi">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="keterangan_serta_merta" class="form-label">Keterangan Formulir
                                </label>
            ...
            <div class="card table-responsive p-md-4 p-2">
                <table class="table table-striped" id="myTable">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Judul Formulir Permohonan Informasi</th>
                            <th>File Formulir Permohonan Informasi</th>
                            <th>Keterangan</th>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{ asset('storage/fileInformasiSertaMerta/' . $item->file_serta_merta) }}"
                                            target="_blank">Lihat
                                            File Formulir Permohonan Informasi
                                        </a>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td class="text-end pe-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/admin/fpi/edit/{{ $item->id }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/admin/fpi/delete/{{ $item->id }}" class="menu-link px-3"
