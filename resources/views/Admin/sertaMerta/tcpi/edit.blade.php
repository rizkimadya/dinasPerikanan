    ...
    <div class="row">
        <div class="col-12">
            <div class="card table-responsive p-md-4 p-2">
                <form action="/admin/tcpi/update/{{ $tcpi->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="judul_serta_merta" class="form-label">Judul TCPI <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="judul_serta_merta" id="judul_serta_merta"
                            value="{{ $tcpi->judul_serta_merta }}" placeholder="Masukkan Judul Informasi">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan_serta_merta" id="editor" style="height: 100px; color:#000;">{{ $tcpi->keterangan_serta_merta }}</textarea>
                    </div>
                    <div class="mt-5 justify-content-center d-flex gap-2">
                        <a href="{{ url('/admin/tcpi') }}" class="btn btn-secondary">Kembali</a>
