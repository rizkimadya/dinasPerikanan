...
@section('modal-add')
    ...
    @if ($peta->file_informasi_berkala === null)
        <a href="{{ asset('storage/fileInformasiBerkala/' . $peta->file_informasi_berkala) }}" target="_blank"
    ...
    <div class="row">
        <div class="col-12">
            <div class="card table-responsive p-md-4 p-2">
                <form action="/admin/peta/update/{{ $peta->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul_informasi_berkala"
                            id="judul_informasi_berkala" value="{{ $peta->judul_informasi_berkala }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan_informasi_berkala" id="editor" style="height: 100px; color:#000;">{{ $peta->keterangan_informasi_berkala }}</textarea>
                    </div>
                    <div class="mt-5 justify-content-center d-flex gap-2">
                        <a href="{{ url('/admin/peta') }}" class="btn btn-secondary">Kembali</a>
