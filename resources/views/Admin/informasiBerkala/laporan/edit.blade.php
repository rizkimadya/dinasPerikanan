                ...
                <form action="/admin/laporan/update/{{ $laporan->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul_informasi_berkala"
                            id="judul_informasi_berkala" value="{{ $laporan->judul_informasi_berkala }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan_informasi_berkala" id="editor" style="height: 100px; color:#000;">{{ $laporan->keterangan_informasi_berkala }}</textarea>
                    </div>
