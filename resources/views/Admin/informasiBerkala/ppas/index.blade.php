@extends('LayoutAdmin.app', ['title' => 'PPAS'])
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah PPAS</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ url('/admin/ppas') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div style="max-height: 66vh; overflow: auto">
                            <div class="mb-3">
                                <label for="judul_informasi_berkala" class="form-label">Judul PPAS <span
                                ...
                                <td class="text-end pe-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/admin/ppas/edit/{{ $item->id }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/admin/ppas/delete/{{ $item->id }}" class="menu-link px-3"
