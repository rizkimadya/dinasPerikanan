    ...
    <div class="card table-responsive p-md-4 p-2">
        <div class="row">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" disabled value="{{ $pengaduan->nama_pelapor }}" name="nama_pelapor"
                    id="nama_pelapor" placeholder="Masukkan Nama Pelapor">
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="alamat" class="form-label">Alamat Pelapor</label>
                    <input type="text" class="form-control" disabled value="{{ $pengaduan->alamat }}" name="alamat"
                        id="alamat" placeholder="Masukkan Alamat Pelapor">
                </div>
                <div class="mb-3">
                    <label for="no_telp" class="form-label">Nomor Telpon Pelapor</label>
                    <input type="number" class="form-control" disabled value="{{ $pengaduan->no_telp }}" name="no_telp"
                        id="no_telp" placeholder="Masukkan Nomor Telpon Pelapor">
                </div>
                <div class="mb-3">
                    <label for="tgl_kejadian" class="form-label">Tanggal Kejadian</label>
                    <input type="date" class="form-control" disabled value="{{ $pengaduan->tgl_kejadian }}" name="tgl_kejadian"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" disabled value="{{ $pengaduan->lokasi_kejadian }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" disabled value="{{ $pengaduan->jenis_keluhan }}" name="jenis_keluhan"
                        id="jenis_keluhan" placeholder="Masukkan Jenis Keluhan">
                </div>
                <div class="mb-3">
                    <label for="detail_keluhan" class="form-label">Detail Keluhan</label>
                    <input type="text" class="form-control" disabled value="{{ $pengaduan->detail_keluhan }}"
                        name="detail_keluhan" id="detail_keluhan" placeholder="Masukkan Detail Keluhan">
                </div>
            </div>

            <div class="mb-3">
                <label for="deskripsi_kejadian" class="form-label">Deskripsi</label>
                <textarea name="deskripsi_kejadian" id="editor" disabled style="height: 100px; color:#000;">{{ $pengaduan->deskripsi_kejadian }}</textarea>
            </div>
        </div>
        <div class="mt-5 justify-content-center d-flex gap-2">
            <a href="{{ url('/admin/pengaduan') }}" class="btn btn-primary">Kembali</a>
        </div>
    </div>
@endsection
