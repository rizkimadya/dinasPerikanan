        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Profil Pejabat</h1>
                    ...
                    <form action="{{ url('/admin/pejabat') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div style="max-height: 66vh; overflow: auto">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="profil_pdf" required id="profil_pdf"
                                    accept=".pdf">
                            </div>
                            <div class="mb-3">
                    ...
                    <tbody>
                        @foreach ($pejabat as $item)
                            <tr>
                                ...
                                <td>{{ $item->jabatan }}</td>
                                <td>
                                    <a href="{{ asset('storage/profilPejabat/' . $item->profil_pdf) }}" target="_blank">Lihat
                                        Profil Pejabat PDF
                                    </a>
                                </td>
                                <td class="text-end pe-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/admin/pejabat/edit/{{ $item->id }}"
                                                class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/admin/pejabat/delete/{{ $item->id }}" class="menu-link px-3"
