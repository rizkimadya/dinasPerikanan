@extends('LayoutUser.app', ['title' => 'PPAS'])

@section('content')
    <section id="heroDetail" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <div class="text-center">
                @if ($ppas->file_informasi_berkala === null)
                    <p></p>
                @else
                    <a href="{{ asset('storage/fileInformasiBerkala/' . $ppas->file_informasi_berkala) }}" target="_blank"
    ...
    <section class="">
        <div class="container">
            <div class="row mb-5">
                <div class="col-12">
                    <h1>{{ $ppas->judul_informasi_berkala }}</h1>
                    <p>{!! $ppas->keterangan_informasi_berkala !!}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Informasi</h2>
                <h3>PPAS <span> Lainya</span></h3>
            </div>

            <div class="row">
                @foreach ($ppasLain as $item)
                    <div class="col-md-3 mb-3 mb-md-4 d-flex" data-aos="zoom-in" data-aos-delay="200">
                        <div class="card p-md-4 p-3 text-center w-100">
                            ...
                            <a href="/ppas/detail/{{ $item->id }}" class="btn text-light"
