...
@section('content')
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1> Sertifikat Kelayakan</span></h1>
            <h2>Dinas Kelautan & Perikanan Provinsi Sulawesi Selatan</h2>
            <div class="d-flex">
                <a href="#sertifikatKelayakan" class="btn-get-started scrollto">Lihat Informasi</a>
            </div>
        </div>
    </section>

    <!-- ======= Pengumuman Section ======= -->
    <section id="sertifikatKelayakan" class="services section-bg">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
                <h2>Informasi</h2>
                <h3>Sertifikat Kelayakan</span></h3>
             ...
             <div class="row mb-4">
                <div class="col-md-12">
                    <form action="{{ url('/sertifikat-kelayakan') }}/#sertifikatKelayakan" method="GET">
