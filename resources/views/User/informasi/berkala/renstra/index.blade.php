@extends('LayoutUser.app', ['title' => 'Rencana Strategis'])

@section('content')
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1> Rencana <span>Strategis </span></h1>
            <h2>Dinas Kelautan & Perikanan Provinsi Sulawesi Selatan</h2>
            <div class="d-flex">
                <a href="#renstra" class="btn-get-started scrollto">Lihat Informasi</a>
            </div>
        </div>
    </section>

    <!-- ======= Pengumuman Section ======= -->
    <section id="renstra" class="services section-bg">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
                <h2>Informasi</h2>
                <h3>Rencana <span>Strategis</span></h3>
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <form action="{{ url('/rencana-strategis') }}/#renstra" method="GET">
                ...
                @foreach ($renstra as $item)
                    <div class="col-md-3 mb-3 mb-md-4 d-flex" data-aos="zoom-in" data-aos-delay="200">
                        <div class="card p-md-4 p-3 text-center w-100">
                            ...
                            <a href="/rencana-strategis/detail/{{ $item->id }}" class="btn text-light"
