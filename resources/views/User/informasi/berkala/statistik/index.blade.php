...
@section('content')
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1> Statistik</span></h1>
            <h2>Dinas Kelautan & Perikanan Provinsi Sulawesi Selatan</h2>
            <div class="d-flex">
                <a href="#statistik" class="btn-get-started scrollto">Lihat Informasi</a>
            </div>
        </div>
    </section>
    ...
    <section id="statistik" class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <form action="{{ url('/statistik') }}/#statistik" method="GET">
