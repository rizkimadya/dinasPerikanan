...
@section('content')
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1> Hasil Laboratorium</span></h1>
            <h2>Dinas Kelautan & Perikanan Provinsi Sulawesi Selatan</h2>
            <div class="d-flex">
                <a href="#hasilLaboratorium" class="btn-get-started scrollto">Lihat Informasi</a>
            </div>
        </div>
    </section>

    <!-- ======= Pengumuman Section ======= -->
    <section id="hasilLaboratorium" class="services section-bg">
        <div class="container" data-aos="fade-up">

            <div class="section-title">
                <h2>Informasi</h2>
                <h3>Hasil Laboratorium</span></h3>
             ...
             <div class="row mb-4">
                <div class="col-md-12">
                    <form action="{{ url('/hasil-laboratorium') }}/#hasilLaboratorium" method="GET">
