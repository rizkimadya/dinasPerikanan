@extends('LayoutUser.app', ['title' => 'Peta'])
...
@section('content')
    ...
    <section class="">
        <div class="container">
            <div class="row mb-5">
                <div class="col-12">
                    <h1>{{ $peta->judul_informasi_berkala }}</h1>
                    <p>{!! $peta->keterangan_informasi_berkala !!}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="services section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Informasi</h2>
                <h3>Peta <span> Lainya</span></h3>
            </div>

            <div class="row">
                @foreach ($petaLain as $item)
                    <div class="col-md-3 mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="card p-md-4 p-3 text-center">
                            ...
                            <a href="/peta/detail/{{ $item->id }}" class="btn text-light"
